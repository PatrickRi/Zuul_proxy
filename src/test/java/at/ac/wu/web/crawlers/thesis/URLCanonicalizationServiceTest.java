...
public class URLCanonicalizationServiceTest {
    ...
    private void normalizeTest(String input, String normal) throws Exception {
        Assert.assertEquals("normalizing: " + input, normal, new URLCanonicalizationService().normalize(input));
    }
}
